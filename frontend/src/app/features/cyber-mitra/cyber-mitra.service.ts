...
export class CyberMitraService {
  private readonly HISTORY_KEY = 'safeclick_mitra_history';
  ...
  private fallbackResponse: IntentResponse = {
    keywords: [],
    en: "I am not entirely sure about that. Could you please provide more details? Are you asking about a suspicious message, a hacked account, or reporting a fraud? You can also explore SafeClick's tools for specific checks.",
