...
@Component({
  ...
  template: `
    <div class="container legal-page">
      ...
      <p>Cycysafeclick is an educational cybersecurity awareness portal. The public version is designed to avoid collecting personal data on Cycysafeclick servers.</p>
      ...
      <ul>
        ...
        <li>Local browser storage is not sent to Cycysafeclick servers, but anyone with access to your device or browser profile may be able to access it.</li>
      ...
      <p>We do not publish or maintain a public database of alleged scammer identifiers. Do not submit personal data about yourself or another person through Cycysafeclick tools.</p>

      <h2>Third-party services</h2>
      <p>The password breach checker uses the Pwned Passwords API with k-anonymity. Only a SHA-1 hash prefix is sent to that service; your full password is never transmitted by Cycysafeclick.</p>

      <h2>External links</h2>
      <p>We link to official resources such as cybercrime.gov.in, RBI, CERT-In, and other public authorities. Those sites have their own privacy policies. Cycysafeclick is not affiliated with, sponsored by, or endorsed by those organizations.</p>
      ...
      <p>Cycysafeclick is designed to comply with the <strong>Digital Personal Data Protection (DPDP) Act, 2023</strong> and the <strong>Information Technology Act, 2000</strong>. We follow the principles of purpose limitation, data minimization, and storage limitation.</p>
      <ul>
        ...
        <li><strong>Data Retention:</strong> Cycysafeclick does not retain personal data on servers. All client-side data can be cleared via browser settings at any time.</li>
      ...
      <ul>
        <li><strong>Email:</strong> dpo&#64;Cycysafeclick-project.in</li>
