...
export class NumberLookupService {
  ...
  public async lookupNumber(input: string): Promise<LookupResult> {
    ...
    return {
      ...
      riskLevel: 'unknown',
      message: isValid
        ? 'SafeClick does not publish a public scam-number database. Use official channels to verify or report fraud.'
        : 'Please enter a valid 10-digit Indian phone number.',
      messageHindi: isValid
        ? 'SafeClick सार्वजनिक स्कैम-नंबर डेटाबेस प्रकाशित नहीं करता। सत्यापन/रिपोर्टिंग के लिए आधिकारिक चैनलों का उपयोग करें।'
