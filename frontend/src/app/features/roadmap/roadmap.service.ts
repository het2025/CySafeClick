...
export class RoadmapService {
  ...
  getTasks(): RoadmapTask[] {
    return [
      ...
      { day: 17, week: 3, title: 'Run WiFi Safety Test', description: 'Check if your home network is secure.', instructions: ['Use the SafeClick WiFi Safety Tester tool'] },
      ...
      { day: 30, week: 4, title: 'Final Assessment', description: 'Retake the Digital Safety Quiz.', instructions: ['Take the SafeClick Digital Safety Quiz', 'Compare your score to Day 0'] }
    ];
  }
}
