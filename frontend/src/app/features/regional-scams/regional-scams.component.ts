...
@Component({
  selector: 'safeclick-regional-scams',
  standalone: true,
  ...
  template: `
    ...
    <safeclick-location-onboarding *ngIf="showOnboarding || (!userLocation().stateId && !hasSkippedOnboarding)"
