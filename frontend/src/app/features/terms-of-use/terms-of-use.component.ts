...
@Component({
  ...
  template: `
    <div class="container legal-page">
      <h1>Terms of Use</h1>
      <p>CySafeClick provides educational cybersecurity awareness content only. By using this site, you agree to the terms below.</p>
      ...
      <p>CySafeClick is not affiliated with, sponsored by, or endorsed by any government body, bank, telecom operator, payment platform, CERT-In, RBI, TRAI, police, or law‑enforcement agency. Names and links are provided only to help users find official resources.</p>

      <h2>No allegations database</h2>
      <p>Do not use CySafeClick to publish accusations, phone numbers, UPI IDs, emails, websites, or other identifiers of alleged scammers. Community reporting and public identifier lookup features are disabled.</p>
      ...
      <p>To the maximum extent permitted by law, CySafeClick and its contributors shall not be liable for any direct, indirect, incidental, or consequential damages arising from the use of this platform or reliance on its content. This includes but is not limited to financial losses, data breaches, or decisions made based on tool outputs.</p>
