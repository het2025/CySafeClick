...
@Component({
  selector: 'safeclick-location-onboarding',
  standalone: true,
  ...
  styles: [`
    ...
    .modal-header h2 { font-size: 2rem; color: var(--safeclick-navy); margin: 0 0 0.5rem 0; }
    ...
    .grid-item.selected { border-color: var(--safeclick-navy); background: #f1f5f9; box-shadow: 0 0 0 1px var(--safeclick-navy); }
    ...
    .btn-primary { background: var(--safeclick-navy); color: white; }
