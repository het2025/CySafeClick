...
- **Senior Citizens:** A dedicated "Senior Safe Mode" with large text, high-contrast color themes, simple navigation, voice assistance, and special guides for UPI, simplified OTP and QR code verification, identifying fraudulent investment schemes targeted at retirees, identifying fraudulent pension arrears notification scams, identifying fraudulent reverse mortgage schemes, spotting fake life insurance maturity claim scams, detecting fraudulent digital life certificate (Jeevan Pramaan) submission apps, spotting fake medical bill reimbursement scams, and WhatsApp safety.
- **Students & Youth:** Gamified learning modules, interactive quizzes, password labs that reward "Cyber Champion" badges to build strong digital habits early, safe usage of digital study material sharing platforms, and curated cybersecurity career pathways and resources for aspiring professionals.
- **Homemakers:** Practical, jargon-free guides on avoiding online shopping fraud, spotting fake social media giveaways, fake delivery scams, electricity bill fraud prevention, spotting fake cooking gas (LPG) subsidy renewal scams, detecting fraudulent kitchen appliance warranty extension calls, work-from-home job fraud, identifying fraudulent domestic help background verification portals, identifying fake charity donation appeals, spotting fraudulent investment schemes, and OTP theft.
- **Rural Internet Users:** Bilingual support (Hindi/English), regional voice-guided UI navigation, low-bandwidth optimized images, SMS-based offline fallback for critical alerts, regional agricultural and crop insurance scam awareness, awareness around fraudulent rural housing (PMAY-G) loan schemes, detecting fraudulent digital literacy certification (PMGDISHA) scams, detecting fraudulent rural electrification (DDUGJY) application scams, detecting fraudulent PM-Kisan tractor subsidy scams, and offline PWA accessibility to break language and connectivity barriers in cyber education.
...
- **India Threat Map:** Live interactive heatmaps of cybercrime hotspots across different Indian states (streamed via real-time WebSockets), featuring state-wise filtering, district-level granularity, automated prediction of emerging cybercrime clusters using ARIMA modeling, automated export of threat intelligence reports for local researchers, and historical trend analysis to break down the most common scams geographically.
- **Cyber Mitra AI:** A 24/7 bilingual assistant powered by Groq with sub-second response times, leveraging **Retrieval-Augmented Generation (RAG)**, memory-based conversational context spanning across multiple active sessions, automated generation of custom digital hygiene action plans based on conversation history, automated extraction of scam URLs from user chat input, voice-to-text input support for regional dialects, and voice-based regional slang understanding to provide accurate, context-aware legal guidance. It acts as a digital first-responder to help users identify if they are being scammed, guides them through recovery steps, and provides specialized support for detecting and reporting loan app harassment tactics (including detecting predatory micro-loan app terms of service).
- **Cyber Law Guide:** A simplified, plain-English breakdown of the IT Act (2000) fully aligned with the new **Bharatiya Nyaya Sanhita (BNS)**, covering consumer protection rights in digital commerce, digital stalking and extortion defense (including automated generation of digital stalking cease-and-desist templates), automated RTI (Right to Information) draft generation for tracking cyber police complaints, and including a searchable index of recent BNS case studies, so citizens easily understand their digital rights.
...
- **Phishing Guard:** A lightweight, protective browser extension that alerts you to suspicious links, blocks typosquatted domains and punycode homograph attacks, features automated blocking of malicious clipboard hijacking scripts, automated isolation of suspect tabs, and flags zero-day fake government websites without draining your battery.
- **Password Lab:** An educational tool featuring real-time, client-side (offline) entropy calculation using the industry-standard zxcvbn algorithm (including predictable keyboard walk detection and automated detection of repeated character patterns (e.g., '111111'))—and secure HaveIBeenPwned database cross-referencing via k-Anonymity—alongside biometric passkey (WebAuthn) setup, automated passkey fallback mechanisms for legacy devices, and synchronization tutorials to help users understand what makes a password truly "unhackable" without sending data to a server.
- **Direct Reporting Guide:** A zero-friction, step-by-step UI detailing exactly how to file an official FIR, including auto-generating draft FIR templates (with regional language translation and offline saving of incomplete drafts), PDF evidence reports with e-Sign digital signature support, automated generation of chronologically ordered evidence timelines, automated generation of localized audio-transcribed complaint summaries, and a directory of nodal cyber officers for escalating ignored complaints, simplifying complex forms for the 1930 Helpline and the [National Cyber Crime Reporting Portal](https://cybercrime.gov.in).
- **E-Commerce Safety Guide:** Learn how to identify fake shopping websites (featuring live fake-website URL analysis), detect dropshipping scams, avoid fake customer care number scams, verify seller authenticity (including verifying seller GSTIN numbers via government portals), identifying fake festive season mega-sale portals, spotting fake flash sale countdown timers, identifying fraudulent airline ticket booking aggregators, spotting fraudulent second-hand furniture marketplace listings, spot deceptive reviews (with fake customer review AI detection techniques), and use secure payment methods to prevent financial loss.
- **Personal Safety Score:** A quick interactive quiz that audits your daily online habits, includes simulated dark web exposure analysis, calculates your vulnerability to scams, and generates a personalized, downloadable PDF action plan (including automated generation of family digital safety guidelines) with historical safety tracking charts to improve your digital safety.
- **Scam Fact Checker:** An instant verification tool that cross-references a crowdsourced national database and performs reverse image searches, automated WHOIS domain age lookup for suspicious links, automated analysis of shortened bit.ly and tinyurl links, automated analysis of QR code payloads, voice cloning pattern analysis, automated detection of deepfake audio voice cloning, and video deepfake analysis to check if a viral WhatsApp forward, SMS offer, lottery win, or OTP request is real or a known scam.
- **Cyber Glossary:** A searchable dictionary (with fuzzy-matching) of complex cyber terms broken down into simple, easy-to-understand definitions, including a crowdsourced dictionary of emerging phishing buzzwords, a crowdsourced dictionary of emerging deepfake terminology, and a slang dictionary for modern gaming, UPI, Digital Wallet, and cryptocurrency terms.
- **Daily Cyber Tips:** Bite-sized, actionable security advice (including automated generation of custom digital hygiene infographics and animated infographic summaries) curated by certified cybersecurity professionals, delivered in regional languages via audio-visual desktop and mobile PWA web push notifications, and featuring gamified daily streak tracking with automated gamification rewards for consecutive daily logins.
- **Student Safety Module:** Specialized gamified curriculum focusing on social media hygiene, safe use of public Wi-Fi networks, anti-doxxing training, academic plagiarism extortion defense, safe usage of digital assignment submission portals, safe usage of AI homework helpers to prevent prompt injection attacks, safe usage guidelines for peer-to-peer (P2P) cryptocurrency trading, interactive cyberbullying prevention scenarios, identifying fraudulent scholarship application portals, detecting fraudulent remote internship offers, detecting fraudulent study abroad visa schemes, gaming safety, and digital parenting guides for guardians.
...
- **Compatibility & QA:** Fully tested across Chrome, Firefox, Safari, and Edge (featuring automated progressive enhancement fallbacks for older browsers), with a strict ESLint configuration and End-to-End testing powered by Cypress.
- **Performance:** Optimized with Angular AOT compilation, Server-Side Rendering (SSR) for improved SEO, automated state hydration optimization, automated Critical Path CSS extraction, Web Workers for heavy client-side calculations, automated deduplication of API requests via RxJS, automated bundle chunking for optimized cache hit rates, automated deferral of non-critical JavaScript execution, aggressive tree shaking for optimized bundle sizes, automated bundle analysis via Webpack Bundle Analyzer, Brotli compression for reduced payload size, automated asset preloading, automated WebP image optimization, and route-level lazy loading for fast initial paint, even on low-bandwidth 3G networks.
...
- **UI Architecture:** 100% Mobile-first responsive design featuring subtle haptic feedback on touch devices, micro-animations for enhanced engagement, automated structural directive usage for optimized DOM rendering, automated DOM rendering analytics, automated DOM sanitation for XSS prevention, automated CSS scoping via Angular's ViewEncapsulation, and an automated OLED-friendly "true black" Dark Mode, built with a strict "no dark patterns" policy for honest user navigation.
- **PWA Ready:** Configured with `ngsw-config.json` for offline caching and background sync for deferred FIR submissions, featuring automated handling of intermittent network drops via Service Worker interceptors, and an automated prompt for users to install the app when device storage allows — ensuring key awareness content remains accessible even without an internet connection.

### Backend (Node.js API)
- **Runtime & Framework:** Node.js, Express.js
- **Architecture:** Fully decoupled RESTful and GraphQL API design with automated API documentation via Swagger UI, automated error tracking via Sentry, automated WebSocket connection health checks, automated circuit breakers for external API integrations, automated load balancing using Nginx reverse proxies, automated rate limit tracking dashboards, future-proofed for gRPC microservice communication and horizontal scaling via Kubernetes.
- **Database:** MongoDB Atlas (Mongoose ODM) configured for high-throughput NoSQL scalability with strict schema validation, automated index optimization, automated slow query logging, automated daily backups, and automated daily disaster recovery drills for data resilience, paired with Redis for low-latency session caching and automated Redis cache invalidation strategies.
- **Security:** Zero-trust architecture using Helmet.js, Express Rate Limiter (including automated rate-limiting specifically for login endpoints to thwart credential stuffing attacks) and GraphQL query depth limiting (to prevent DDoS, brute-force attacks, and resource exhaustion), strict CORS policies, robust Content Security Policy (CSP), end-to-end payload encryption for sensitive reporting data, automated nightly vulnerability scanning, automated dependency vulnerability scanning via Snyk, automated SQL injection prevention via Mongoose strict schema enforcement, automated API key rotation, automated JWT token revocation strategies on compromised sessions, and zero telemetry collection.
...
- **Functionality:** Real-time DOM scanning, cross-origin communication with background service workers, heuristic scanning of deceptive visual homographs in URLs, and automatic blocking of malicious hidden iframes and crypto-jacking scripts.
...
- [ ] Integration with Central Electricity Regulatory Commission (CERC) APIs to verify smart meter installation requests and prevent utility fraud.
...
- **Open Source Transparency:** All of our code is publicly available and subject to regular third-party security auditing by the community, regular penetration testing by independent security researchers, independent bug bounty program audits to secure user data, and periodic independent SOC2 compliance audits.
- **Data Encryption:** Any data in transit between the client and our AI backend is secured via AES-256 encryption and the TLS 1.3 protocol, with automated rotation of cryptographic salt keys every 90 days.
- Threat reports and AI chat histories are processed securely, undergo strict automated sanitization of all PII, are scrubbed of sensitive data (including automated hashing of IP addresses in access logs using Argon2, automated scrubbing of geolocation metadata from uploaded evidence, and automated sanitization of uploaded document EXIF data), and subject to automated memory wiping for active sessions and automated 30-day log rotation and deletion.
